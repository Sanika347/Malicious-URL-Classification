...
lgs_count = pickle.load(open('lgs_count.pkl', 'rb'))
lgs_tfidf = pickle.load(open('lgs_tfidf.pkl', 'rb'))
mnb_count = pickle.load(open('mnb_count.pkl', 'rb'))
mnb_tfidf = pickle.load(open('mnb_tfidf.pkl', 'rb'))
svm_count = pickle.load(open('svm_count.pkl', 'rb'))
svm_tfidf = pickle.load(open('svm_tfidf.pkl', 'rb'))
rf_count = pickle.load(open('rf_count.pkl', 'rb'))
rf_tfidf = pickle.load(open('rf_tfidf.pkl', 'rb'))
...
def predict():
    ...
    df = pd.DataFrame()
    df1 = pd.DataFrame({'URL':url, 'Vectorizer':vec, 'ML Model':ml, 'Prediction':pred, 'Probability':prob}) 
